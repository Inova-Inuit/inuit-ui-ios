...
#ifndef INUITUI_SWIFT_H
#define INUITUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="InuitUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7InuitUI20CollectionController")
@interface CollectionController : NSObject <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout>
/// Collection view used for…emm…collection viewing
@property (nonatomic, weak) IBOutlet UICollectionView * _Nullable collectionView;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (void)deleteModeLongPress:(UILongPressGestureRecognizer * _Nonnull)recognizer;
- (void)backgroundTap:(UITapGestureRecognizer * _Nonnull)recognizer;
...
SWIFT_PROTOCOL("_TtP7InuitUI28CollectionControllerDelegate_")
@protocol CollectionControllerDelegate
@optional
- (BOOL)collectionControllerShouldSelectItem:(id <CollectionViewCellDataProtocol> _Nonnull)data controller:(CollectionController * _Nonnull)controller SWIFT_WARN_UNUSED_RESULT;
- (BOOL)collectionControllerShouldDeselectItem:(id <CollectionViewCellDataProtocol> _Nonnull)data controller:(CollectionController * _Nonnull)controller SWIFT_WARN_UNUSED_RESULT;
- (void)collectionControllerWillSelectItem:(id <CollectionViewCellDataProtocol> _Nonnull)data controller:(CollectionController * _Nonnull)controller;
- (void)collectionControllerDidSelectItem:(id <CollectionViewCellDataProtocol> _Nonnull)data controller:(CollectionController * _Nonnull)controller;
- (void)collectionControllerDidDeselectItem:(id <CollectionViewCellDataProtocol> _Nonnull)data controller:(CollectionController * _Nonnull)controller;
- (void)collectionControllerDidScroll:(CGPoint)contentOffset controller:(CollectionController * _Nonnull)controller;
- (void)collectionControllerWillEndDragging:(UIScrollView * _Nonnull)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(CGPoint * _Nonnull)targetContentOffset;
- (void)collectionControllerDidEndDragging:(UIScrollView * _Nonnull)scrollView willDecelerate:(BOOL)decelerate;
- (void)collectionControllerDidEndScrollAnimation:(UIScrollView * _Nonnull)scrollView;
- (void)collectionControllerDidEndDecelerating:(UIScrollView * _Nonnull)scrollView;
- (void)collectionControllerDidScrollToTop:(UIScrollView * _Nonnull)scrollView;
@end
...
SWIFT_CLASS("_TtC7InuitUI22CollectionReusableView")
@interface CollectionReusableView : UICollectionReusableView
@property (nonatomic, strong) IBOutlet UIView * _Nullable cellContentView;
@property (nonatomic, strong) IBOutlet UIScrollView * _Nullable cellScrollView;
@property (nonatomic, strong) IBOutlet UIButton * _Nullable deleteButton;
@property (nonatomic, strong) IBOutlet UIView * _Nullable cellHighlightView;
...
SWIFT_CLASS("_TtC7InuitUI18CollectionViewCell")
...
SWIFT_PROTOCOL("_TtP7InuitUI30CollectionViewCellDataProtocol_")
@protocol CollectionViewCellDataProtocol
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull cellIdentifiers;
/// TODO remove this and replace with pressHandler from CellMetaData.
@property (nonatomic, copy) void (^ _Nullable pressHandler)(void);
@property (nonatomic, copy) void (^ _Nullable deletePressHandler)(void);
@property (nonatomic, copy) NSArray<UITableViewRowAction *> * _Nullable swipeActions;
@property (nonatomic) BOOL preventSelect;
@optional
@property (nonatomic) BOOL canDelete;
@required
@property (nonatomic) BOOL canMove;
@optional
@property (nonatomic, copy) NSArray<id <CollectionViewCellDataProtocol>> * _Nullable subContent;
@property (nonatomic) BOOL expandOnSelect;
@end


SWIFT_CLASS("_TtC7InuitUI22CollectionViewCellData")
@interface CollectionViewCellData : NSObject <CollectionViewCellDataProtocol>
@property (nonatomic, copy) NSArray<NSString *> * _Nonnull cellIdentifiers;
@property (nonatomic, copy) void (^ _Nullable pressHandler)(void);
@property (nonatomic, copy) void (^ _Nullable deletePressHandler)(void);
@property (nonatomic, copy) NSArray<UITableViewRowAction *> * _Nullable swipeActions;
...
SWIFT_CLASS("_TtC7InuitUI25CollectionViewSectionData")
@interface CollectionViewSectionData : NSObject
@property (nonatomic, copy) void (^ _Nullable pressHandler)(void);
@property (nonatomic, copy) void (^ _Nullable deletePressHandler)(void);
@property (nonatomic, copy) NSArray<UITableViewRowAction *> * _Nullable swipeActions;
@property (nonatomic) BOOL preventSelect;
...
SWIFT_CLASS("_TtC7InuitUI9ImageView")
...
SWIFT_CLASS("_TtC7InuitUI20ScrollRefreshControl")
@interface ScrollRefreshControl : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC7InuitUI15TableController")
...
SWIFT_PROTOCOL("_TtP7InuitUI23TableControllerDelegate_")
@protocol TableControllerDelegate
@optional
- (BOOL)tableController:(TableController * _Nonnull)controller shouldSelectRowForData:(id <CollectionViewCellDataProtocol> _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
- (BOOL)tableController:(TableController * _Nonnull)controller shouldDeselectRowForData:(id <CollectionViewCellDataProtocol> _Nonnull)data SWIFT_WARN_UNUSED_RESULT;
- (void)tableControllerDidScroll:(CGPoint)contentOffset controller:(TableController * _Nonnull)controller;
- (void)tableControllerWillEndDragging:(UIScrollView * _Nonnull)scrollView withVelocity:(CGPoint)velocity targetContentOffset:(CGPoint * _Nonnull)targetContentOffset;
@end


SWIFT_CLASS("_TtC7InuitUI13TableViewCell")
